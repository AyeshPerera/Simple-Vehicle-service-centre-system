 ...
 * @author Ayesh Perera
 */
public class StoreDel extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String Qry2 = "DELETE FROM `alightmotors`.`store` WHERE `store`.`Itm_No` = "+uid+"";
        executeqry(Qry2, "Deleted");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StoreDel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
