...
public class carrier extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Carrier Service");
        ...
        jButton6.setText("Edit V-Deliver Status");
        ...
        jButton9.setText("Vehicle handed");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Booking Number", "Vehicle Number", "Booking Date", "Booking Type", "Approval", "Cl_Info_Status", "Confirmed Date", "Job Status", "Vehicle Delivered"
            }
        ));
    ...
    public ArrayList<BookingT> getbookingList(){
        ...
        String qyr="SELECT * FROM `bookings` WHERE `Booking_Type` LIKE 'carrier' ORDER BY `Booking_Nmbr` ASC";
        Statement st;
        ResultSet rs;
    ...
    public ArrayList<BookingT> getcondate(){
        ...
        String qyr="SELECT * FROM `bookings` WHERE `Booking_Type` LIKE 'carrier' AND `Booking_Date` = '"+toDate+"'";
        Statement st;
        ResultSet rs;
    ...
    public ArrayList<BookingT> getClientinfo(){
        ...
        String qyr="SELECT * FROM `bookings` WHERE `Booking_Type` LIKE 'carrier' AND `Vehicle_Released` = 'yes' ORDER BY `Booking_Nmbr` ASC";
        Statement st;
        ResultSet rs;
    ...
    public ArrayList<BookingT> getClientaprd(){
        ...
        String qyr="SELECT * FROM `bookings` WHERE `Approval` = 'yes' AND `Cl_Info_Stat` LIKE 'yes' ORDER BY `Booking_Nmbr` ASC";
        Statement st;
        ResultSet rs;
    ...
    public ArrayList<BookingT> getJobDone(){
        ...
        String qyr="SELECT * FROM `bookings` WHERE `Booking_Type` LIKE 'carrier' AND  `Job_Status` LIKE 'yes' ORDER BY `Booking_Nmbr` ASC ";
        Statement st;
        ResultSet rs;
    ...
    public ArrayList<BookingT> getClientnotaprd(){
        ...
        String qyr="SELECT * FROM `bookings` WHERE `Approval` = '' or `Approval` = 'no' AND `Cl_Info_Stat` LIKE 'yes'  ORDER BY `Booking_Nmbr` ASC";
        Statement st;
        ResultSet rs;
    ...
    public ArrayList<BookingT> getsearchres(){
        ...
        Connection con=mn.getcon();
        String qyr="SELECT * FROM `bookings` WHERE `Booking_Type` LIKE 'carrier' AND `Approval` LIKE 'yes' AND `Cl_Info_Stat` LIKE 'yes' AND `Booking_Nmbr` LIKE '%"+search+"%' or `Vehicle_Released` LIKE '%"+search+"%' or `Client_Nmbr` LIKE '%" +search+ "%' or `Booking_Type` = '" +sbtp+ "' or `Job_Status` = '" +sjts+ "'";
     ...
     public ArrayList<BookingT> getsearchresr1(){
        ...
        Connection con=mn.getcon();
        String qyr="SELECT * FROM `bookings` WHERE `Booking_Type` LIKE 'carrier' AND `Booking_Nmbr` LIKE '"+search+"'";
     ...
     public ArrayList<BookingT> getsearchresr2(){
        ...
        Connection con=mn.getcon();
        String qyr="SELECT * FROM `bookings` WHERE `Booking_Type` LIKE 'carrier' AND `Client_Nmbr` LIKE '"+search+"'";
     ...
     public ArrayList<BookingT> getsearchresr3(){
        ...
        Connection con=mn.getcon();
        String qyr="SELECT * FROM  `bookings` WHERE `Booking_Type` LIKE 'carrier' AND `Booking_Type` = '" +search+ "' ";
     ...
     public ArrayList<BookingT> getsearchresr4(){
        ...
        Connection con=mn.getcon();
        String qyr="SELECT * FROM `bookings` WHERE `Booking_Type` LIKE 'carrier' AND `Job_Status` = '" +search+ "'";
    ...
    public ArrayList<BookingT> getsearchresr5(){
        ...
        Connection con=mn.getcon();
        String qyr="SELECT * FROM `bookings` WHERE `Booking_Type` LIKE 'carrier' AND `Vehicle_Released` = '" +search+ "'";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        new Carrierjds().setVisible(true);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        new Carriervhsts().setVisible(true);
