 ...
 * @author Ayesh Perera
 */
public class Bookingaprve extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Approve  Bookings");

        jLabel2.setText("Booking Number : ");

        jButton1.setText("Approve Booking");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String Qry2 = "UPDATE `alightmotors`.`bookings` SET `Approval` = 'yes' WHERE `bookings`.`Booking_Nmbr` = "+uid+";";
        executeqry(Qry2, "Booking Approved");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bookingaprve.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              new Bookingaprve().setVisible(true);
            }
        });
    }
