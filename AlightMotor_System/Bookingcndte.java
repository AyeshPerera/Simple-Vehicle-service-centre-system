 ...
 * @author Ayesh Perera
 */
public class Bookingcndte extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Client Infromation Bookings");
        ...
        jLabel3.setText("Confermation Date");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String Qry2 = "UPDATE `alightmotors`.`bookings` SET `Confirmed_Date` = '"+dte+"' WHERE `bookings`.`Booking_Nmbr` = "+uid+";";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bookingcndte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
