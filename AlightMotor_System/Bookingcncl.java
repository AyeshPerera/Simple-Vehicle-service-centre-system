 ...
 * @author Ayesh Perera
 */
public class Bookingcncl extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String Qry2 = "DELETE FROM `alightmotors`.`bookings` WHERE `bookings`.`Booking_Nmbr` = "+uid+"";
        executeqry(Qry2, "Booking Cancelled");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bookingcncl.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
