...
public class Garage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton9.setText("Vehicle Released");
    ...
    public ArrayList<BookingT> getbookingList(){
        ...
        String qyr="SELECT * FROM `bookings` WHERE `Booking_Type` LIKE 'garage' ORDER BY `Booking_Nmbr` ASC";
        Statement st;
        ResultSet rs;
    ...
    public ArrayList<BookingT> getcondate(){
        ...
        String qyr="SELECT * FROM `bookings` WHERE `Booking_Type` LIKE 'garage' AND `Booking_Date` = '"+toDate+"'";
        Statement st;
        ResultSet rs;
    ...
    public ArrayList<BookingT> getClientinfo(){
        ...
        String qyr="SELECT * FROM `bookings` WHERE `Booking_Type` LIKE 'garage' AND `Vehicle_Released` LIKE 'yes' ORDER BY `Booking_Nmbr` ASC";
        Statement st;
        ResultSet rs;
    ...
    public ArrayList<BookingT> getClientaprd(){
        ...
        String qyr="SELECT * FROM `bookings` WHERE `Booking_Type` LIKE 'garage' AND `Approval` = 'yes' ORDER BY `Booking_Nmbr` ASC";
        Statement st;
        ResultSet rs;
    ...
    public ArrayList<BookingT> getJobDone(){
        ...
        String qyr="SELECT * FROM `bookings` WHERE `Booking_Type` LIKE 'garage' AND  `Job_Status` LIKE 'yes' ORDER BY `Booking_Nmbr` ASC ";
        Statement st;
        ResultSet rs;
    ...
    public ArrayList<BookingT> getClientnotaprd(){
        ...
        String qyr="SELECT * FROM `bookings` WHERE `Booking_Type` LIKE 'garage' AND `Approval` = '' ORDER BY `Booking_Nmbr` ASC";
        Statement st;
        ResultSet rs;
    ...
    public ArrayList<BookingT> getsearchres(){
        ...
        Connection con=mn.getcon();
        String qyr="SELECT * FROM `bookings` WHERE `Booking_Type` LIKE 'garage' AND `Booking_Nmbr` LIKE '"+search+"' or `Vehicle_Released` LIKE '%"+search+"%' or `Client_Nmbr` LIKE '%" +search+ "%' or `Booking_Type` = '" +sbtp+ "' or `Job_Status` = '" +sjts+ "'";
     ...
     public ArrayList<BookingT> getsearchresr1(){
        ...
        Connection con=mn.getcon();
        String qyr="SELECT * FROM `bookings` WHERE `Booking_Type` LIKE 'garage' AND `Booking_Nmbr` LIKE '"+search+"'";
     ...
     public ArrayList<BookingT> getsearchresr2(){
        ...
        Connection con=mn.getcon();
        String qyr="SELECT * FROM `bookings` WHERE `Booking_Type` LIKE 'garage' AND `Client_Nmbr` LIKE '"+search+"'";
     ...
     public ArrayList<BookingT> getsearchresr3(){
        ...
        Connection con=mn.getcon();
        String qyr="SELECT * FROM  `bookings` WHERE `Booking_Type` LIKE 'garage' AND `Booking_Type` = '" +search+ "' ";
     ...
     public ArrayList<BookingT> getsearchresr4(){
        ...
        Connection con=mn.getcon();
        String qyr="SELECT * FROM `bookings` WHERE `Booking_Type` LIKE 'garage' AND `Job_Status` = '" +search+ "'";
    ...
    public ArrayList<BookingT> getsearchresr5(){
        ...
        Connection con=mn.getcon();
        String qyr="SELECT * FROM `bookings` WHERE `Booking_Type` LIKE 'garage' AND `Vehicle_Released` = '" +search+ "'";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        new Garagejdsts().setVisible(true);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        new Garagevhsts().setVisible(true);
