 ...
 * @author Ayesh Perera
 */
public class Garagejdsts extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Change Job Status");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String Qry2 = "UPDATE `alightmotors`.`bookings` SET `Job_Status` = 'yes' WHERE `bookings`.`Booking_Nmbr` ="+uid+";";
        executeqry(Qry2, "Job is DOne");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Garagejdsts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
