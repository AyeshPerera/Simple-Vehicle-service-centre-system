 ...
 * @author Ayesh Perera
 */
public class deleteVehi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Vehicele Nmbr");

        jButton1.setText("Delete Vehi");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String Qry2 = "DELETE FROM `alightmotors`.`cli_vehi` WHERE `Vehi_Nmbr` LIKE '"+uid+"';";
        executeqry(Qry2, "Delete Vehicle");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(deleteVehi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
